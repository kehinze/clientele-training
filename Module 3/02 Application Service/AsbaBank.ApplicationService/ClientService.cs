...
namespace AsbaBank.ApplicationService
{
    ...
    {
        void RegisterClient(RegisterClient command);
        void UpdateClientAddress(UpdateClientAddress command);
    }
    ...
    public class ClientService : IClientService
    {
        ...
        public void RegisterClient(RegisterClient command)
        {
        ...
        public void UpdateClientAddress(UpdateClientAddress command)
        {
            IRepository<Client> clientRepository = unitOfWork.GetRepository<Client>();
